...
class AbstractPayloadDecoder(object):
    ...
    def valueDecoder(self, substrate, asn1Spec,
        ...
        raise error.PyAsn1Error(
            'SingleItemDecoder not implemented for %s' % (tagSet,))  # TODO: Seems more like an NotImplementedError?
    ...
    def indefLenValueDecoder(self, substrate, asn1Spec,
        ...
        The decoder is allowed to consume as many bytes as necessary.
        """
        raise error.PyAsn1Error('Indefinite length mode decoder not implemented for %s' % (
